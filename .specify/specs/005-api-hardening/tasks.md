...
- [ ] **T2 — Additive migration: `ContactMessage.archivedAt` (doc 09 D09-14)** *(needs T1)*
...
- [ ] **T3 — Archive-transition sets/clears `archivedAt` (doc 09 D09-14)** *(needs T2)*
...
- [ ] **T4 — Retention purge: service method + scheduler (doc 19 §6 D19-10, doc 07 §5 D07-3)** *(needs T3)*
...
- [ ] **T5 — `archivedAt` on entity + Swagger + contract export (doc 10 §1, doc 16 §3)** *(needs T3)*
...
- [ ] **T6 [P] — NFR-006 latency smoke + CI wiring (doc 20 §5/§7 D20-7)** *(needs T2 for a migrated DB; independent of purge)*
...
- [ ] **T7 [P] — Audit regression coverage + body-limit fix (doc 19 §4/§5/§6/§11, doc 07 §5) [verify; one evidenced fix]** *(needs T1; independent)*
...
- [ ] **T8 — E2e for purge + archive-transition (doc 18 §2)** *(needs T4 + T5)*
...
- [ ] **T9 — Integration verification (coordinator; verifier lane)** *(needs T6, T7, T8)*
...
- [ ] **T10 — Autonomous reviews (separate lane) [security · code · contract · test]** *(needs T9)*
