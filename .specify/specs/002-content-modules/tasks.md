...
- [ ] T3 — Skills module (doc 02 §4 FR-CNT-040, doc 10)
...
- [ ] T4 [P] — Projects module (FR-CNT-020 + `isPublished`, FR-PUB-012/030–033, doc 10) — *needs T3*
...
- [ ] T7 [P] — Articles related endpoint (FR-PUB-044 [S], doc 04 §5, doc 10, doc 18)
...
- [ ] T8 [P] — Settings extension: career start (FR-DSH-070, doc 10)
...
- [ ] T10 — Swagger + contract export (doc 10 §1)
...
- [ ] T12 — Integration verification (coordinator)
