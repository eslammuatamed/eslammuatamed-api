...
`PUBLIC_WEB_URL`. ما يخصّ هذا الملفّ هو **شكل** التحقّق لا محتواه، والأشكال الحاضرة اليوم — **بمثال لكلٍّ، لا حصرًا**
— خمسة: المطلق (`DATABASE_URL`)؛ والمشروط بوضعٍ آخر (`STORAGE_LOCAL_DIR` للمحرّك المحلّي، و`S3_*`
