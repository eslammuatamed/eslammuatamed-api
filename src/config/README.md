...
- **`DATABASE_URL` له قاعدة صيغة صريحة (doc 07 §3 · doc 16 §1):** سلسلة اتصال `postgresql://`/`postgres://` بلا مسافات — فقيمة مشوَّهة تُرفَض عند الإقلاع بدل أن تظهر كخطأ اتصال غامض لاحقًا.
