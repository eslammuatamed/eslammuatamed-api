...
- **قوائم بلا ترقيم:** التصنيفات/الوسوم مجموعات صغيرة ثابتة تُعاد كمصفوفة (`{ data: [...] }`) لا كصفحات.
...
`categories.service.spec.ts` (+ سلوك الوسوم مغطّى e2e ضمن المقالات). e2e ذات صلة: `test/articles.e2e-spec.ts` (تصفية بالتصنيف/الوسم).

## أخطاء شائعة

- توقّع ترقيم على هذه القوائم — لا يوجد.
