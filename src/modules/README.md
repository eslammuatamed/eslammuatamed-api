...
- **Controller رفيع، Service سمين:** الـ controller يوجّه ويربط الـ DTO ويحمل decorators الـ Swagger، و**قواعد المجال** موضعها الـ service (`principle 13`) — **وهذا هو الاتجاه المُلزِم، لا مسحٌ مُتحقَّق منه لكلّ ثابتٍ في المستودع:** ثمّة ثوابت تُنفَّذ عند حدّ الطلب وحده، لا في خدمةٍ ولا في قاعدة البيانات — كتالوج المنح في [`access-control`](access-control/README.md)، وقواعد شكل ترويسة `Idempotency-Key` في [`contact`](contact/README.md) — فاقرأ القاعدة توجيهًا معماريًّا لا ضمانًا.
