...
// exports the descriptor resolver for public reads (T7). RedirectsModule exports RedirectService so
// update() can push buildRedirectOps into its rename transaction (D04-6, T7); no cycle — redirects
...
// it for the mint existence check + getPreviewById (T6, constitution rule 2 — cross-module use is
