...
// access via exported services only (doc 07 §1). MediaModule exports `MediaDescriptorResolver`,
// which resolves the public résumé descriptor. PrismaService comes from the global module.
@Module({
