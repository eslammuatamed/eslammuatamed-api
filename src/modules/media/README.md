...
وذلك عكس ما كان يفعله الترتيب القديم (الكائنات أوّلًا ثمّ الصفّ)، وهو خطأ `C-6` المُصحَّح.
