...
// (doc 10 §1, doc 18). This module is the single registration boundary for that oracle — specs
...
// repo-owned evaluator below overrides toSatisfyApiSpec — the later expect.extend wins.
// The effective matcher is therefore owned by ./format-enforcement: structural validation
// (route/method/status/$ref/nullable/allOf) delegates to @ehuelsmann/openapi-validator's
// public validateResponse as the first gate, and format validation runs only after it passes.
// No other authored module may import or register the fork directly.
//
